...
// TradeRoyaltyRelationRes 查询分账关系返回值
type TradeRoyaltyRelationRes struct {
...
//type AlipayTradeRoyaltyRelationBatchqueryResponse struct { // alipay_trade_royalty_relation_batchquery_response
//	Code    string `json:"code"`
//	Msg     string `json:"msg"`
//	SubCode string `json:"sub_code"`
//	SubMsg  string `json:"sub_msg"`
